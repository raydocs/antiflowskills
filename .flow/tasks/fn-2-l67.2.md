...
## Done summary
Created .factory/skills/ directory structure with .gitkeep and flow-example template skill demonstrating repo root resolution strategy with fallback error handling.
## Evidence
- Commits: d51349069992b81d45da850dc42d69cb42e369e8
- Tests: flowctl list from .flow subdir, fallback error from /tmp
- PRs: