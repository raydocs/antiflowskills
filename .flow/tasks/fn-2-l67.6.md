...
## Done summary
Verified RepoPrompt integration in Factory environment. All acceptance tests passed: rp-cli 1.6.0 available, context builder functional, chat-send returns AI responses, worktree scenario works. Documented MCP status (not tested - optional) and non-macOS fallback strategy with user prompts.
## Evidence
- Commits: 95c86c5cd6d70a43bc622527f7a503398114e457
- Tests: rp-cli --version, rp-cli builder test, flowctl rp chat-send test, git worktree verification
- PRs: