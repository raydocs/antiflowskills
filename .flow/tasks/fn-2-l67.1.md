...
## Done summary
Verified Factory environment and completed comprehensive tool mapping documentation. Created .flow/docs/factory-environment-verification.md with: tool mapping table (all Claude tools have Factory equivalents), SKILL.md format requirements, Verification section format, skill naming conventions, cwd rules, auxiliary file support, and subagent invocation mechanism.
## Evidence
- Commits: eac72c64b82ff783a23cc4783e9cbea15218588d
- Tests: Factory documentation review - https://docs.factory.ai/cli/configuration/skills
- PRs: